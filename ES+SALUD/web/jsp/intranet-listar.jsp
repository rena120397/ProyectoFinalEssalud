            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <thead class="thead-dark">
                        <c:if test="${(accion eq 'goListarAdm')}">
                ...
                <c:if test="${(accion eq 'goListarMedicos')}">
                ...
                <c:if test="${(accion eq 'goListarPacientes')}">
                    <c:if test="${(bUsuario.ID_PERFIL == 1) || (bUsuario.ID_PERFIL == 2)}">
                        <tr>
                            <th>HI_NREG</th>
                            <th>HI_NOMBRE</th>
                        ...
                        <tbody>
                            <c:forEach items="${listapaciente}" var="p">
                                <tr>
                                    ...
                                    <td><a target="_blank" href="${pageContext.request.contextPath}/pdf?accion=<c:out value="${p.HI_NREG}" />" download="<c:out value="${p.HI_NREG}" />">>   Obtener contraseña</a></td>
                                </tr>               
                            </c:forEach> 
                        </tbody>
                        </table>
