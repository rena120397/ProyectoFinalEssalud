                        ...
                        <div class="form-check">
                            <div class="card">
                                    ...
                                    <div class="card-body font-weight-bold">
                                        <input type="radio" class="form-check-input" name="rc" value="<c:out value="${c.idprogmedic}" />" > <c:out value="${c.espemedico}" /> / <c:out value="${c.nomedico}" />  / <c:out value="${c.fecha}" />  -- Cupo disponible <c:out value="${c.cupo}" /> 
                                    </div>
                                    </label>    
                            </div>
                        </div>
