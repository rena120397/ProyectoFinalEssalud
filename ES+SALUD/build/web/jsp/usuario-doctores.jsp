...
<html lang="en">
  ...
  <!-- Links -->
        ...
        <div class="container padd">
            <h2>Doctores Disponible:</h2><hr>
            <div class="row">
                <c:forEach items="${listadoctor}" var="d">
                <c:choose>
                <c:when test="${not empty d.idoctor}">
                <div class="col-md-3">
                    <div class="card text-white font-weight-bold">
                        <div class="card-header bg-info"><c:out value="${d.nombred}" /></div>
                         <div class="card-body bg-secondary ">
                             <p>Especialidad: <c:out value="${d.especialidad}" /></p>
                             <p>Edad: 40</p>
                         </div> 
                    </div>
                </div>
